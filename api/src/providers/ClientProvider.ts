...
export class ClientProvider implements ICrud<IClient> {
    ...
    public insert(object: IClient): Observable<any> {
        const sql = `INSERT INTO CLIENT(CLI_DESCRIPTION, CLI_CNPJ, CLI_STATUS, CLI_NOTES, CLI_DT_CREATE, CLI_DT_UPDATE)
                    VALUE (?,?,?,?,?,?)`;
